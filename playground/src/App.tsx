...
import {
  ...
  Smartphone, SwatchBook, RefreshCw, ListCollapse,
  // 추가 아이콘 (누락 메뉴용)
  AlertOctagon, MapIcon, ArrowUpDown, Coins, Columns3, Pipette,
  Stamp, Pen, Network, Filter, LayoutList, Search, MessageSquare,
  Eye, Rss, Wand2, Contact, FileType, PanelBottomClose, ListTree,
  AtSign, Crop, ShieldCheck, BellDot, Pin, Scale, Smile,
  ChevronsDown, Cloud, ThumbsUp, Cookie, Volume2, Newspaper,
  KeyRound, Globe, Quote, Link2, Users, Rocket, QrCode,
  CalendarCheck, ClipboardCopy, SunMoon, LineChart, Workflow,
  Flag, Rows2, Plus, Watch,
} from "lucide-react";
...
const pageIcons: Record<string, ReactNode> = {
  ...
  "bottom-nav": <Smartphone size={16} />,
  "swipe-action": <SwatchBook size={16} />,
  "pull-to-refresh": <RefreshCw size={16} />,
  "action-sheet": <ListCollapse size={16} />,
  // 누락 아이콘 추가
  "banner-alert": <AlertOctagon size={16} />,
  "shortcut-map": <MapIcon size={16} />,
  "sortable-list": <ArrowUpDown size={16} />,
  "currency-input": <Coins size={16} />,
  "kanban-board": <Columns3 size={16} />,
  "color-swatch": <Pipette size={16} />,
  "description-list": <LayoutList size={16} />,
  "toggle-group": <Rows2 size={16} />,
  "watermark": <Stamp size={16} />,
  "image-comparison": <Columns3 size={16} />,
  "signature-pad": <Pen size={16} />,
  "org-chart": <Network size={16} />,
  "filter-bar": <Filter size={16} />,
  "data-card": <CreditCard size={16} />,
  "approval-flow": <Workflow size={16} />,
  "search-highlight": <Search size={16} />,
  "status-dot": <Circle size={16} />,
  "bar-list": <BarChart3 size={16} />,
  "sparkline": <LineChart size={16} />,
  "donut-chart": <PieChart size={16} />,
  "heat-map": <LayoutGrid size={16} />,
  "comment-thread": <MessageSquare size={16} />,
  "file-preview": <Eye size={16} />,
  "activity-feed": <Rss size={16} />,
  "date-range-picker": <CalendarRange size={16} />,
  "form-wizard": <Wand2 size={16} />,
  "user-card": <Contact size={16} />,
  "rich-text-preview": <FileType size={16} />,
  "bottom-sheet": <PanelBottomClose size={16} />,
  "virtual-list": <ListTree size={16} />,
  "cron-builder": <Clock size={16} />,
  "mention-input": <AtSign size={16} />,
  "image-cropper": <Crop size={16} />,
  "time-slot-picker": <CalendarDays size={16} />,
  "permission-table": <ShieldCheck size={16} />,
  "notification-bell": <BellDot size={16} />,
  "progress-tracker": <Flag size={16} />,
  "pin-board": <Pin size={16} />,
  "tree-select": <FolderTree size={16} />,
  "comparison-table": <Scale size={16} />,
  "reaction-picker": <Smile size={16} />,
  "poll-widget": <BarChart3 size={16} />,
  "read-more": <ChevronsDown size={16} />,
  "tag-cloud": <Cloud size={16} />,
  "feedback-widget": <ThumbsUp size={16} />,
  "cookie-consent": <Cookie size={16} />,
  "audio-player": <Volume2 size={16} />,
  "stopwatch": <Watch size={16} />,
  "changelog": <Newspaper size={16} />,
  "password-checklist": <KeyRound size={16} />,
  "browser-frame": <Globe size={16} />,
  "testimonial": <Quote size={16} />,
  "stats-grid": <BarChart3 size={16} />,
  "link-preview": <Link2 size={16} />,
  "avatar-stack": <Users size={16} />,
  "feature-card": <Rocket size={16} />,
  "number-stepper": <Plus size={16} />,
  "qr-code": <QrCode size={16} />,
  "event-card": <CalendarCheck size={16} />,
  "copy-field": <ClipboardCopy size={16} />,
  "info-tip": <Info size={16} />,
  "grid-list": <LayoutGrid size={16} />,
  "theme-toggle": <SunMoon size={16} />,
};
